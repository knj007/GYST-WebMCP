...
The current hosted aggregate was 16 demo users and 5 permanent Auth users when last checked on 2026-09-07. The Vercel dashboard can separately be enabled for free page views at [Analytics](https://vercel.com/knj007/gyst-web-mcp/analytics). No Vercel plan upgrade or remote application mutation was made.

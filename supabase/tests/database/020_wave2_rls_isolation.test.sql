...
insert into public.weekly_entries (id, user_id, ritual_session_id, decision_text, arrow, priorities)
values
  ('a7000000-0000-4000-8000-000000000001', '11111111-1111-4111-8111-111111111111', 'a5000000-0000-4000-8000-000000000002', 'Decision A', 'steady', '[{"title":"Priority A","due_on":"2026-09-01"}]'),
  ('b7000000-0000-4000-8000-000000000001', '22222222-2222-4222-8222-222222222222', 'b5000000-0000-4000-8000-000000000002', 'Decision B', 'steady', '[{"title":"Priority B","due_on":"2026-09-01"}]');

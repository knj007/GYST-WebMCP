...
- Database evidence: the production Wave 2 gate passed at 120 pgTAP assertions. The local Wave 3 redesign replays with 156 assertions and error-level lint, but it remains unreviewed and has not passed the full W3 evidence gate.

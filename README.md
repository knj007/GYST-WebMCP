...
- Database evidence: the production Wave 2 gate passed at 120 pgTAP assertions. The local Wave 3 prototype replays with 135 assertions and error-level lint, but its human-only commit authorization design is blocked by security review and has not passed W3.
